// Либо вообще убрать веб-интерфейс или сделать его минималистичным чисто для быстрого доступа до информации
// Улучшить интерфейс на OLED, поскольку он кривой и слишком маленький
